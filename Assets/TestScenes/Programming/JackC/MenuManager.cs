...
public class MenuManager : MonoBehaviour
{
    ...
    private void OnEnable()
    {
        ...
        StartCoroutine(RedrawHUD(pHealth, pClass, pCurrentAmmo, pMaxAmmo, pIron, pBlood));
    }
    ...
    private IEnumerator RedrawHUD(float health, string currentClass, float ammo, float maxAmmo, float iron, float blood) // Updates UI all at once
    {
        weaponControl.currentWeapon.gunFired -= OnWeaponShoot;
